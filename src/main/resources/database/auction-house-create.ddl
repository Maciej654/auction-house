...
ALTER TABLE ads ADD CONSTRAINT ad_pk PRIMARY KEY ( auction );
...
ALTER TABLE auctions ADD CONSTRAINT auctions_pk PRIMARY KEY ( auction_id );
...
ALTER TABLE auctions_logs ADD CONSTRAINT auctions_histories_pk PRIMARY KEY ( timestamp,
                                                                                  auction );
...
ALTER TABLE books ADD CONSTRAINT books_pk PRIMARY KEY ( auction );
...
ALTER TABLE cars ADD CONSTRAINT cars_pk PRIMARY KEY ( auction );
...
ALTER TABLE defaults ADD CONSTRAINT defaults_pk PRIMARY KEY ( auction );
...
ALTER TABLE delivery_preferences ADD CONSTRAINT delivery_preferences_pk PRIMARY KEY ( address,
                                                                                      "user" );
...
ALTER TABLE followers ADD CONSTRAINT followers_pk PRIMARY KEY ( follower,
                                                                followee );
...
ALTER TABLE items_in_shopping_carts ADD CONSTRAINT shopping_carts_pk PRIMARY KEY ( buyer,
                                                                                   auction );
...
ALTER TABLE personal_ads ADD CONSTRAINT personal_ads_pk PRIMARY KEY ( recipient,
                                                                      auction );
...
CREATE TABLE phones (
    ...
    proccessor        VARCHAR2(64) NOT NULL,
...
ALTER TABLE phones ADD CONSTRAINT phones_pk PRIMARY KEY ( auction );
...
ALTER TABLE pictures ADD CONSTRAINT pictures_pk PRIMARY KEY ( path,
                                                              auction );
...
ALTER TABLE ratings ADD CONSTRAINT ratings_pk PRIMARY KEY ( reviewer,
                                                            auction );
...
ALTER TABLE books
    ADD CONSTRAINT books_fk FOREIGN KEY ( auction )
        REFERENCES auctions ( auction_id );

ALTER TABLE cars
    ADD CONSTRAINT cars_fk FOREIGN KEY ( auction )
        REFERENCES auctions ( auction_id );

ALTER TABLE defaults
    ADD CONSTRAINT defaults_fk FOREIGN KEY ( auction )
        REFERENCES auctions ( auction_id );
...
ALTER TABLE phones
    ADD CONSTRAINT phones_fk FOREIGN KEY ( auction )
        REFERENCES auctions ( auction_id );
